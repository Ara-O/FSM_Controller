...
def generate_launch_description():
    ...
    default_map_file = os.path.join(get_package_share_directory('udm_pioneer_p3dx'), 'p3dx_navigation', 'maps', 'S_full_rn.yaml')
    ...
    robot1_group = create_robot_group('1', 'robot1', 'robot1_tf', '-x  -y  -z 0.0')
    robot2_group = create_robot_group('2', 'robot2', 'robot2_tf', '-x  -y  -z 0.0')
